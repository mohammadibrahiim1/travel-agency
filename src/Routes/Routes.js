...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        // loader: https://travel-zone-server-zeta.vercel.app/api/flights/6416b5e2b758fbc5342d890d
        loader: async ({ params }) =>
          fetch(`https://travel-zone-server-zeta.vercel.app/api/flights/${params.id}`),
      },
      {
        path: "/findHotels",
      ...
      },
      {
        ...
        loader: async ({ params }) =>
          fetch(`https://travel-zone-server-zeta.vercel.app/carServices/${params.id}`),
      },
      {
        path: "/packages",
